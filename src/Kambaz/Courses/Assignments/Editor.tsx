      ...
      <div className="col-md-9">
        ...
        <div className="row mb-3">
          ...
          <div className="col pt-2 border rounded-2 me-3 ms-3">
            ...
            <input type="date" id="wd-due-date" className="form-control" defaultValue="2025-02-21" />

            <div className="row mb-3">
              <div className="col-sm-6">
                <label htmlFor="wd-available-from" className="col-form-label m-2 ms-1 mb-0 fw-bold">Available From</label>
                <input type="date" id="wd-available-from" className="form-control" defaultValue="2025-02-21" />
              </div>
              <div className="col-sm-6">
                <label htmlFor="wd-available-to" className="col-form-label m-2 ms-1 mb-0 fw-bold"> Until</label>
                <input type="date" id="wd-available-to" className="form-control" defaultValue="2025-02-21" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="d-flex justify-content-end mt-3">
          <Link to={`/Kambaz/Courses/${cid}/Assignments`} className="btn btn-light me-2" id="wd-course-assignment-link">Cancel</Link>
          <Link to={`/Kambaz/Courses/${cid}/Assignments`} className="btn btn-success btn-danger" id="wd-course-assignment-link">Save</Link>
        </div>
        </div>
      </div>
  </div>
